    ...
    public function store(BannerStoreRequest $request)
    {
        ...
        while (true) {
            ...
            if ($count2>0) {
                ...
                $data=array('title' => request('title'), 'slug' => $slug, 'text' => request('text'), 'button' => request('button'), 'button_text' => request('button_text'), 'pre_url' => $pre_url, 'url' => request('url'), 'target' => $target, 'type' => request('type'), 'state' => request('state'));
                break;
            }
        }
