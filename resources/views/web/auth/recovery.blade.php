		...
		<div class="row mx-0">
			...
			<div class="col-xl-3 col-lg-6 col-md-8 col-sm-10 col-12 mt-2 pt-2 mx-auto mr-login">
				<div class="card border-0" id="login">
					...
					<form class="card-body" action="{{ route('recovery.custom') }}" method="POST" id="formLogin">
						{{ csrf_field() }}
						<div class="row">
							<div class="col-12">
							...
							<div class="form-group col-12">
								<button type="submit" class="btn btn-blue-light text-white font-weight-bold text-uppercase rounded-1 w-100 py-3" action="login">Enviar</button>
							</div>
