...
@section('title', 'Editar Subcategoría de Examenes')
			...
			<div class="widget-header">
				<div class="row">
					<div class="col-xl-12 col-md-12 col-sm-12 col-12">
						<h4>Editar Subcategoría de Examenes</h4>
					</div>                 
				</div>
			</div>
						...
						<form action="{{ route('subcategorias.update', ['slug' => $subcategory->slug]) }}" method="POST" class="form" id="formSubcategory">
							...
							<div class="row">
								<div class="form-group col-lg-12 col-md-12 col-12">
									...
									<input class="form-control" type="text" disabled value="{{ $subcategory->category->name }}">
								</div>
