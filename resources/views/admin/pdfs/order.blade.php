...
<body>
	...
	<div id="content">
		...
		<div class="w-100 mb-3">
			<p class="mb-0">{{ $exam->exam->subcategory->category->name }}</p>
			<p class="mb-0"><b>COD FNS:</b> <span class="mr-3">{{ $exam->exam->subcategory->code }}</span> {{ $exam->exam->subcategory->name }}</p>
		</div>
		@endforeach
