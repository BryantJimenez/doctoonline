									...
									<tr>
										...
										<td>
											<div class="btn-group" role="group">
												<a href="{{ route('informes.show', ['slug' => $report->slug]) }}" class="btn btn-primary btn-sm bs-tooltip" title="Informe"><i class="fa fa-eye"></i></a>
												...
												@endif
												<button type="button" class="btn btn-danger btn-sm bs-tooltip" title="Eliminar" onclick="deleteReport('{{ $report->slug }}')"><i class="fa fa-trash"></i></button>
											</div>
										</td>
									</tr>
									@endforeach
...
<div class="modal fade" id="deleteReport" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">¿Estás seguro de que quieres eliminar este informe?</h5>
			...
			<div class="modal-footer">
				...
				<form action="#" method="POST" id="formDeleteReport">
					@csrf
					@method('DELETE')
